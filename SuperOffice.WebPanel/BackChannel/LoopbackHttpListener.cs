...
namespace SuperOffice.WebPanel.BackChannel
{
    public class LoopbackHttpListener : IDisposable
    {
        ...
        private void SetResult(string value, HttpContext ctx)
        {
            try
            {
                ...
                ctx.Response.WriteAsync("<h1>You are successfully logged in.</h1>");
                ctx.Response.WriteAsync("<h1>See the console to proceed with web panels.</h1>");
